namespace GymTestBL.Models
{
    ...
    {
        public CyclingSession(int cyclingSessionId, DateTime date, TimeSpan duration, float avgWatt, float maxWatt, float avgCadence, float maxCadence, string trainingType, string comment, int memberId)
        {
